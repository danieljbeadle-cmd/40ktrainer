...
const MODIFIERS = [
  ...
  },
  {
    ...
    description: "Each time an attack is made with such a weapon, if that attack scores a Critical Wound, no saving throw of any kind can be made against that attack (including invulnerable saving throws). Such attacks are only allocated to models after all other attacks made by the attacking unit have been allocated and resolved. After that attack is allocated and after any modifiers are applied, it inflicts a number of mortal wounds on the target equal to the Damage characteristic of that attack, instead of inflicting damage normally.",
    ...
    didYouKnow: "Devastating Wounds completely bypasses invulnerable saves. The mortal wounds go straight through, with the exception of Feel No Pain — making it uniquely powerful against heavily-protected targets like Daemons.",
  },
  {
    name: "Torrent",
    icon: "🌊",
  ...
  },
  {
    ...
    icon: "💣",
    color: "#f0a020",
    oneliner: "[ANTI-KEYWORD X+]: An unmodified Wound roll of ‘x+’ against a target with the matching keyword scores a Critical Wound.",
    ...
    category: "Special Rule",
    synergies: ["FIX THIS"],
    antiSynergies: ["FIXX THIS","FIX THIS"],
    didYouKnow: "FIX THIS",
  },
  {
    name: "Indirect Fire",
  ...
  },
  {
    ...
    icon: "🔥",
    color: "#ff6a00",
    oneliner: "Within half range, add X to the weapon's damage.",
    description: "If the target is within half the weapon's Range characteristic, add X to this weapon's Damage characteristic for that attack. A MELTA 2 weapon adds 2 damage.",
  ...
  },
  {
    ...
    icon: "🎯",
    color: "#00e5cc",
    oneliner: "Wounds can be allocated to a CHARACTER hiding within a unit.",
    description: "When targeting an Attached unit, the attacking model’s player can have the attack allocated to a CHARACTER model in that unit visible to the bearer.",
    category: "Special Rule",
